...
from archive.src.detectors.motion_detection_helpers import (
    is_displaced,
    is_stopped,
...
from archive.src.detectors.motion_detection_helpers import DataFilter
...
class LossOfContactDetectorNode(MotionStatechartNode, AbstractContactDetector):
    ...
    def trigger_events(
        ...
        if len(objects_that_lost_contact) == 0:
            return []
        return self.get_events(
            objects_that_lost_contact, contact_bodies, LossOfContactEvent
        )
